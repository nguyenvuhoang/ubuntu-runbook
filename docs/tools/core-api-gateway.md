...
> Lưu ý bảo mật: Không commit token thật, password thật, client secret thật hoặc thông tin tài khoản thật lên repository public/internal nếu không cần thiết. Các giá trị bên dưới nên được xem là ví dụ hoặc cần được thay bằng biến môi trường/secret nội bộ.
...
Trong collection sẽ có các API thường dùng như:
...
`tool`, `core-api-gateway`, `postman`, `api`, `token`, `core`, `transaction`, `backend`
